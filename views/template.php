		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active">
					<a class="nav-link" href="index.php?action=home">Page d'accueil<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="index.php">Le Blog</a> <!-- AFFICHER QUE LE DERNIER ARTICLE -->
				</li>
				<li class="nav-item">
					<a class="nav-link disabled" href="index.php">Les publications</a>
				</li>
			</ul>
		</div>
	</nav>
